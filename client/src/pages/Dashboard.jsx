    ...
    <div style={S.page}>
      <div style={S.header}>
        ...
        <div style={S.headerRight}>
          ...
          <span style={S.ombrivonBadge}>OMBRIVON</span>
...
const S = {
  ...
  ombrivonBadge: { background: 'rgba(255,68,68,0.1)', color: '#ff4444', border: '1px solid rgba(255,68,68,0.3)', borderRadius: 20, padding: '4px 12px', fontSize: 11, letterSpacing: 2, fontFamily: 'monospace' },
};