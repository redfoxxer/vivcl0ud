  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <p style={styles.subtitle}>Create your private account</p>
        <div style={styles.ombrivon}>
          <img src="/ombrivon-logo.png" style={{ height: 24, verticalAlign: 'middle', marginRight: 6 }} />
          Protected by <span style={{ color: '#ff4444', letterSpacing: 2 }}>OMBRIVON</span>
        </div>
...
const styles = {
  ...
  subtitle: { color: 'rgba(255,255,255,0.5)', fontSize: 14, marginBottom: 6 },
